        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    media_url_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ingredient", x => x.id);
                    table.ForeignKey(
                        name: "FK_ingredient_media_url_media_url_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recipe_cover_image = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    date_created = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_recipe_media_url_recipe_cover_image",
                        column: x => x.recipe_cover_image,
                        principalTable: "media_url",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    section_order = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ingredient_section", x => x.id);
                    table.ForeignKey(
                        name: "FK_ingredient_section_ingredient_ingredient_id",
                        column: x => x.ingredient_id,
                        principalTable: "ingredient",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ingredient_section_media_url_media_url_id",
                        column: x => x.media_url_id,
                        principalTable: "media_url",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ingredient_media_url_id",
                table: "ingredient",
                column: "media_url_id",
                unique: true,
                filter: "[media_url_id] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ingredient_section_ingredient_id",
                table: "ingredient_section",
                column: "ingredient_id");

            migrationBuilder.CreateIndex(
                name: "IX_ingredient_section_media_url_id",
                table: "ingredient_section",
                column: "media_url_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recipe_recipe_cover_image",
                table: "recipe",
                column: "recipe_cover_image",
                unique: true,
                filter: "[recipe_cover_image] IS NOT NULL");
